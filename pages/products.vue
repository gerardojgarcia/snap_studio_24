...
<template>
  <div class="flex flex-col">
    <nav class="md:space-x-4 h-10">
      ...
      <NuxtLink class="hover:text-red-200 focus:text-red-200 cursor-pointer">Consoles</NuxtLink>
      <NuxtLink class="hover:text-red-200 focus:text-red-200 cursor-pointer">Bookcases</NuxtLink>
      <NuxtLink class="hover:text-red-200 focus:text-red-200 cursor-pointer">Built-ins</NuxtLink>
    </nav>
    <div>
